<div id="requestTest" class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Request for a Test</h1>

      <form class="main-form" action="{{url('requestTestAppointment')}}" method="POST">
        @csrf
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select name="test" id="test" class="custom-select" required="">
                ...
                <option value="{{$test->name}}">{{$test->name}}---{{$test->fee}}tk</option>
                @endforeach
            </select>
          </div>
